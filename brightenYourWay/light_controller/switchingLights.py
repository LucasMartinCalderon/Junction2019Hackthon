...
def main():
    ...
    if Port_name:
        ...
        if Serial_Device:
            while(1): 
                set_light_level_color_temperature(Serial_Device, 50, 30000, LUMINAIRE_IDs[0])
                time.sleep(1)
                set_light_level_color_temperature(Serial_Device, 0, 30000, LUMINAIRE_IDs[0])
                set_light_level_color_temperature(Serial_Device, 50, 30000, LUMINAIRE_IDs[1])
                time.sleep(1)
                set_light_level_color_temperature(Serial_Device, 0, 30000, LUMINAIRE_IDs[1])                
